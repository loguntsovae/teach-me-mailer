...
async def create_api_key(
    name: str, daily_limit: int = None, is_active: bool = True
) -> tuple[str, str]:
    """
...
async def main():
    ...
    daily_limit_input = input(
        f"Enter daily limit (default: {settings.default_daily_limit}): "
    ).strip()
    ...
    try:
        ...
        print(
            f'     -d \'{{"to": "test@example.com", "subject": "Test", "text": "Hello!"}}\' \\'
        )
